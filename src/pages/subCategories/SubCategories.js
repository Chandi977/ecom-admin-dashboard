                ...
                <div className="col-12">
                    <div className="card">
                        ...
                        >
                            ...
                            <Column filter field="sub_category_id" header="ID" filterElement={() => handleFilter("sub_category_id")} />
                            ...
                            <Column header="Category" body={categoryTemplate} filterElement={() => handleFilter("slug")} />
